...
def residualize_data(data, y='Day Ahead APX Price', n_folds=5):
    data['wind_production_resid'] = residualize_variable_kfold(
        data, 'wind_forecast', ['wind_capacity', 'Daylight Hours', 'Hour', 'Month'], n_folds=n_folds
    )
...
def fit_residualized_model(data):
    ...
    X_residualized = data[['wind_production_resid']]
