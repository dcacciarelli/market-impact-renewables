...
covariates = ['forecasted_solar_penetration']
response = 'Day Ahead APX Price'
...
ax.set_ylabel('Price [GBP/MWh]', fontsize=18, labelpad=10)

# plt.legend([line_mean, line_lower, line_upper], ['Mean prediction', '10% quantile', '90% quantile'], loc='upper right',
#            fontsize=14)
plt.tight_layout()
plt.savefig(f'/Users/dcac/PycharmProjects/day-ahead-wind-forecast/causal_analysis_wind_solar/plots/quantile_solar.png', format='png', dpi=600)
plt.show()
